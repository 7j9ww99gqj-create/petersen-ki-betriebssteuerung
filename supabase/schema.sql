...
-- User-zu-Owner Support-Anfragen und Owner-Broadcasts
...
-- User sieht nur seine Nachrichten; Owner (info@...) sieht alles
...
-- Empfänger und Owner sehen Broadcast-Nachrichten
...
-- Nur Owner kann Broadcasts erstellen
