...
- Letzter dokumentierter Live-Stand: `2026-05-20`, `main`, **Pondruff Preise: Single Source of Truth (JSON-only)**: Admin-Bereich entfernt, `getPriceConfig()` liest jetzt ausschließlich `lib/pondruff-price-config.json` (keine DB-Override mehr), DB-Tabelle `pondruff_price_config` gedroppt. Formel verifiziert gegen User-Excel: 10×20×30 Meta-S = 8.50 €, Ø30×30 Meta-S = 25.50 €. HEAD `2ac0eb8`.
