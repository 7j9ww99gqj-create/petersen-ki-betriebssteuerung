...
- Aktuell in Arbeit am `2026-05-12`:
  ...
  - Der MarketingPilot hat jetzt für jede KI-Funktion einen eigenen Menüpunkt mit read-only Vorschau-Dashboard: Autopilot-Marketing, SEO, Lead Intelligence, A/B Testing, KI-Content, Funnel-Builder, Vertriebsassistent, Sales Clone, Posting-Ideen, Predictive Marketing, Templates, Integrationen, Gamification und Explainability. Die frühere Kartenübersicht wurde dafür durch einzelne Modul-Tabs ersetzt.
