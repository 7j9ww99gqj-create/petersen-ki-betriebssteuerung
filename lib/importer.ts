...
const DATEV_HINTS: Record<string, string> = {
  ...
  'Name': 'lieferant', 'Firma': 'name', 'Kundenname': 'name',
  ...
  'Bezeichnung': 'name', 'Beschreibung': 'beschreibung',
  ...
  'E-Mail': 'email', 'Email': 'email', 'Telefon': 'telefon', 'Tel': 'telefon',
  'Adresse': 'adresse', 'Anschrift': 'adresse', 'PLZ': 'adresse',
  'Notiz': 'notiz', 'Notizen': 'notizen', 'Bemerkung': 'notiz',
